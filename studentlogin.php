...
if($_SERVER["REQUEST_METHOD"] == "POST") {  
  ...
  $sqli = "SELECT `password` FROM `student_password` WHERE prn = '$username'";
  ...
  if($row['password'] == NULL){
          // student has not changed his password check password from student table 
  $sql = "SELECT * FROM `student` WHERE `prn` = '$username' AND `contact`='$password' ";
  ...
  // student has change the password check from student_password table
  $sql = "SELECT * FROM `student_password` WHERE `prn` = '$username' ";
...
<meta charset="utf-8">
          ...
          <title>Sign In As Student</title>
            ...
            <main class="content">
              <div class="container-fluid"><div class="row justify-content-center wfid_temp37494906370" > 
                ...
                <div class="col-md-3 wfid_temp37494906434" ><div class="card wfid_temp37494906498" ><div class="card-header wfid_temp37494906562" >
                  <h5 class="card-title mb-0 wfid_temp37494906626 h5" >Sign In As Student</h5></div><div class="card-body wfid_temp37494906690" >
                    <div class="wfid_panel_itxlogin wfid_temp37494906754" ><div class="wfid_temp37494906818" >
                      ...
                      <form action="/miniproject_final/studentlogin.php" method="post"> 
