...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2023 at 12:41 PM
...
('Tech Mahindra', 8, 'https://careers.techmahindra.com/'),
...
('Pranav', 'Wani', 420, 142200000, 2024, 420, 'pranav@gmail.com', 20, 'computer', 8, 1),
('Tarak', 'Mehta', 421, 1400, 2024, 123456789, 'tarak@gmail.com', 21, 'computer', 8, 1),
...
(45020, 'Vtech Solutions', 7, '  Trainee  '),
...
('faculty', '$2y$10$AnVfqbcsf8QRmK66b7Ka0eVPDh0mIPaqjjfuHeickP/6FFubFBLUS', 'faculty');
...
('admin', 'Pranav', 'Wani ', 7774041842, 'pranavmh18@gmail.com', 'computer'),
('faculty', '', '', 0, '', '');
