...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST") {  
        ...
        // echo "<br>".$num."<br>";
        //user can sign up only if - 
        //1. password = confirm password and
        //2. username is unique i.e same username cannot present in database
        // if( $password == $cpassword && $num == 0) {
            if(  $num == 0) {
            $hash = password_hash($password , PASSWORD_DEFAULT);
            $sql = "INSERT INTO `users` ( `username`, `password`,`role`) VALUES ('$username', '$hash','$role')";
            $sqli="INSERT INTO `users_profile` ( `username`) VALUES ('$username')";
            $result = mysqli_query($conn,$sql);
            $result2 = mysqli_query($conn,$sqli);
            if($result){
                $showAlert = true;
                echo "<script> alert('account is created now you can login') </script>";
            }
        }
        elseif($num>0){
            $showError = "Username already exists try using other usrename";
            echo "<script> alert('Username already exists try using other usrename') </script>";
       }
        // else{
            ...
            <main class="content">
              <div class="container-fluid"><div class="row justify-content-center wfid_temp37494906370" > 
                ...
                <div class="col-md-3 wfid_temp37494906434" ><div class="card wfid_temp37494906498" ><div class="card-header wfid_temp37494906562" >
                  <h5 class="card-title mb-0 wfid_temp37494906626 h5" >Register user</h5></div><div class="card-body wfid_temp37494906690" >
                    <div class="wfid_panel_itxlogin wfid_temp37494906754" ><div class="wfid_temp37494906818" >
                      ...
                      <form action="/miniproject_final/registeruser.php" method="post"> 
                        ...
                        <div class="mb-3 col-sm-12 wfid_temp37494907202" >
                          ...
                          <div class="mb-3 col-sm-12 wfid_temp37494907202" >
                          <label class="form-label text-muted text-sm mb-1 wfid_temp37494907266 nitrogen_label" >Role *</label>
                          <select name="role" class="form-control password wfid_password_bcrypt wfid_temp37494907330 textbox"> 
